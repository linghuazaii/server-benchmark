...
TARGET=$(BLOCKING_SERVER_V1_TARGET) $(BLOCKING_SERVER_V2_TARGET) $(BLOCKING_SERVER_V3_TARGET) $(BLOCKING_SERVER_V4_TARGET) $(BLOCKING_SERVER_V5_TARGET) $(BLOCKING_SERVER_V6_TARGET) $(BLOCKING_SERVER_V7_TARGET) $(BLOCKING_SERVER_V8_TARGET) $(BLOCKING_SERVER_V9_TARGET) $(BLOCKING_SERVER_V10_TARGET) $(BLOCKING_SERVER_V11_TARGET) $(BLOCKING_SERVER_V12_TARGET) $(BLOCKING_SERVER_V13_TARGET)
SRC=$(BLOCKING_SERVER_V1_SRC) $(BLOCKING_SERVER_V2_SRC) $(BLOCKING_SERVER_V3_SRC) $(BLOCKING_SERVER_V4_SRC) $(BLOCKING_SERVER_V5_SRC) $(BLOCKING_SERVER_V6_SRC) $(BLOCKING_SERVER_V7_SRC) $(BLOCKING_SERVER_V8_SRC) $(BLOCKING_SERVER_V9_SRC) $(BLOCKING_SERVER_V10_SRC) $(BLOCKING_SERVER_V11_SRC) $(BLOCKING_SERVER_V12_SRC) $(BLOCKING_SERVER_V13_SRC)
